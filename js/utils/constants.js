  ...
  const DEVLOG_DATA = [
    {
      ...
      details: [
        ...
        '🛠️ [1~5번 셋업 워크플로 완전 정복] 1번(/setup-project: 스택 자동 감지 및 규칙 점검) ➔ 5번(/design-api: 사전 설계) ➔ 코딩 ➔ 3번(/verify: 자동 검증) ➔ 4번(/commit: 스마트 커밋)으로 표준화',
        '🌱 [새 프로젝트 시작 순서] 새 폴더 생성 ➔ "1번 셋업 시작해줘" 실행 (스택 자동 감지 및 표준 AGENTS.md 자동 생성) ➔ 5번 설계 ➔ 기능 구현 ➔ 3번 검증 ➔ 4번 커밋',
